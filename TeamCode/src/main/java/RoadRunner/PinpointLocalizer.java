...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 0.0; // y position of the parallel encoder (in tick units)         (-3440.48354)
        public double perpXTicks = 0.0; // x position of the perpendicular encoder (in tick units)   (-1290.18133)
    }
